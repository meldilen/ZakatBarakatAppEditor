  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/request_answering': (context) =>  RequestAnswerTypePage(request: ModalRoute.of(context)!.settings.arguments as RequestViewModel,),
        '/request_answer_as_question': (context) =>  AnswerAsQuestionPage(request: ModalRoute.of(context)!.settings.arguments as RequestViewModel,),
        '/request_answer_as_article': (context) =>  AnswerAsArticlePage(request: ModalRoute.of(context)!.settings.arguments as RequestViewModel,),
      },
    );
  }
